#This file defines the model for hop prediction task
import torch
...
# This class handles the training of the model for hop prediction task
...
class HopPredictorManager:
    ...
    #Handle one epoch of training a model for hop prediction
    #Returns the average training loss averaged over the training batches  
    ...
    # Performs the validation on a validation set and returns average validation loss and average 
    # validation accuracy averaged over the validation batches
    ...
    #Predicts the hops for the claims in the test set
